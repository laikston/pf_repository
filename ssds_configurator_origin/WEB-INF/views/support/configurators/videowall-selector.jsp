...
<main id="content" role="main">
	<section id="question-box" class="smart-box smart-box choice-question">
		<div class="inbox">
			...
			<ul class="question-btn">
				<li>
					<a href="javascript:;" onclick="configuratorApp.choiceSection.nextStep(this);">
						<img class="icon" alt="">
						<i></i>
			...
			<div class="question-back no-see"><a href="javascript:;" onclick="configuratorApp.choiceSection.prevStep();"><span>BACK</span></a></div>
		</div>
	</section>
	...
	<div class="support-tools-configurator no-see">
		<!-- #videowall-configurator configurator-section -->
		<div id="videowall-configurator" class="configurator-section" ng-app="configurator" ng-controller="configuratorController as videowall"><!-- //ng-app="configurator" ng-controller="configuratorController as videowall"  -->
										...
										<fieldset>
											...
											<div class="box-option">
												<div class="inner">
													...
													<div class="btnarea al-r"><a href="javascript:;" class="g-btn-m-arrow1" ng-click="setMaxVideowall()"><span>Feet to room</span></a></div>
												</div>
											</div>
										</fieldset>
									</div>
									...
									<div id="scenario_background" class="ng-scope">
										...
										<div id="scenario_middle" ng-style="{'height':room.size.pixel_height}">
											<div id="space" style="height:auto;">
												...
												<!-- // 16-08-19 alert delete :: start :: rui13th -->
												<!-- alert -->
												...
												<div id="videoContainer" style="position:absolute;width:100px;height:100px;overflow:hidden;" ng-style="{'top': upload.video.position.top,'left':upload.video.position.left, 'width':display.size.width*display.videowall.col, 'height':display.size.height*display.videowall.row}">
													<video autoplay="" loop="" muted="" ng-show="upload.contents.video != 'Select'" id="vid" style="width:auto;height:auto;" ng-style="videoSize()">
