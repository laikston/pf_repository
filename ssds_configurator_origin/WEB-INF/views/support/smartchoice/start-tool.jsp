...
<script src="/static/js/smartChoice/startToolData.js?201808221500"></script>
...
<main id="content" role="main">
	...
	<article id="lfd-smart-choice" class="webapp-lfd-smart-choice" ng-app="startTool">
		<h1 class="blind">smartChoice_startTool</h1>
    <ng-view></ng-view>
  </article>
</main><hr><!-- // #content -->
...
<!-- for smart choice startTool -->
<script src="/static/js/smartChoice/startToolApp.js?201803281700"></script>
<!-- //ui js -->
